...
class ToS1ViewController: BaseViewController {
    ...
    func addSubViews() {
        ...
        [contentLabel,
         ...
         contentDetailLabel5,
         contentDetailLabel6,
         contentDetailLabel7].forEach { contentView.addSubview($0) }
    }
    ...
    func setupLayout() {
        ...
        contentDetailLabel.snp.makeConstraints {
            ...
            $0.bottom.equalTo(contentDetailLabel2.snp.top)
        }
        
        contentDetailLabel2.snp.makeConstraints {
            $0.top.equalTo(contentDetailLabel.snp.bottom)
            $0.left.right.equalToSuperview().inset(16)
            $0.bottom.equalTo(contentDetailLabel3.snp.top)
        }
        
        contentDetailLabel3.snp.makeConstraints {
            $0.top.equalTo(contentDetailLabel2.snp.bottom)
            $0.left.right.equalToSuperview().inset(16)
            $0.bottom.equalTo(contentDetailLabel4.snp.top)
        }
        
        contentDetailLabel4.snp.makeConstraints {
            $0.top.equalTo(contentDetailLabel3.snp.bottom)
            $0.left.right.equalToSuperview().inset(16)
            $0.bottom.equalTo(contentDetailLabel5.snp.top)
        }
        
        contentDetailLabel5.snp.makeConstraints {
            $0.top.equalTo(contentDetailLabel4.snp.bottom)
            $0.left.right.equalToSuperview().inset(16)
            $0.bottom.equalTo(contentDetailLabel6.snp.top)
        }
        
        contentDetailLabel6.snp.makeConstraints {
            $0.top.equalTo(contentDetailLabel5.snp.bottom)
            $0.left.right.equalToSuperview().inset(16)
            $0.bottom.equalToSuperview().offset(-16)
            $0.bottom.equalTo(contentDetailLabel7.snp.top)
        }
        
        contentDetailLabel7.snp.makeConstraints {
            $0.top.equalTo(contentDetailLabel5.snp.bottom)
            $0.left.right.equalToSuperview().inset(16)
            $0.bottom.equalToSuperview().offset(-16)
        }
    ...
    @objc func buttonTapped(_ sender: UIButton) {
        NotificationCenter.default.post(name: NSNotification.Name("UpdateCell"), object: 0)
